...
TasksManager::TasksManager(QString accT, QObject *parent) :
        QObject(parent)
{
...
QVariantList TasksManager::getTaskLists()
{
    return m_taskLists;
}

QVariantList TasksManager::getTasks()
{
    return m_tasks;
}
...
void TasksManager::getMyTasks(const QString& access_token, const QString& taskListID)
{
...
void TasksManager::createList(const QString& access_token, const QString& title)
{
    QString s = QString("https://www.googleapis.com/tasks/v1/users/@me/lists?access_token=%1").arg(access_token);
    QByteArray params;
...
void TasksManager::deleteList(const QString& access_token, const QString& taskListID)
{
...
void TasksManager::deleteTask(const QString& access_token, const QString& taskListID, const QString& taskID)
{
...
void TasksManager::createTask(const QString& access_token, const QString& taskListID, const QString& title,
...
void TasksManager::updateTask(const QString& access_token, const QString& taskListID, const QString& taskID, const QVariant& json_object) {
    QString s = QString("https://www.googleapis.com/tasks/v1/lists/%1/tasks/%2?access_token=%3").arg(taskListID).arg(
            taskID).arg(access_token);
...
const QString &TasksManager::getAccT() const {
    return _accT;
}

void TasksManager::setAccT(const QString &accT) {
    _accT = accT;
}
